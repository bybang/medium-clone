...
function Post({ post }: Props) {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<IFormInput>(); // use IFormInput as a template here(now the form knows we have only four types above)

  // connect to react hook form to submiting the form on it's own way
  const onSubmit: SubmitHandler<IFormInput> = async (data) => {
    //data knows exactly what type of dataset the form has
    ...
    <main>
      ...
      {submitted ? (
        ...
        >
          ...
          <input
            // connection to the reacthookform
            {...register('_id')}
            type="hidden"
            name="_id"
            value={post._id}
...
// which root it should be pre-build in advance
